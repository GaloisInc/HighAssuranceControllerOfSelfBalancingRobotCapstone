//! Implementation for lustre node `ComputeP` (see [ComputeP](struct.ComputeP.html)).
//!
...
/// Stores the state for **top node** `ComputeP`.
///
/// # Inputs
///
...
#[repr(C)]
  pub struct ComputeP {
  /// Input: `ComputeP.usr.Input`
  pub svar_Input: Real,
  /// Input: `ComputeP.usr.Now`
  pub svar_Now: Real,
  /// Input: `ComputeP.usr.Setpoint`
  pub svar_Setpoint: Real,
  /// Input: `ComputeP.usr.Kp`
  pub svar_Kp: Real,
  /// Input: `ComputeP.usr.Ki`
  pub svar_Ki: Real,
  /// Input: `ComputeP.usr.Kd`
  pub svar_Kd: Real,
  /// Input: `ComputeP.usr.SampleTime`
  pub svar_SampleTime: Real,

  /// Output: `ComputeP.usr.Output`
  pub svar_Output: Real,

  /// Local, call: `ComputeP.res.abs_0`
  pub svar_abs_0: Real,
...
impl Sys for ComputeP {
  type Input = (
    Real, // svar_Input (ComputeP.usr.Input)
    Real, // svar_Now (ComputeP.usr.Now)
    Real, // svar_Setpoint (ComputeP.usr.Setpoint)
    Real, // svar_Kp (ComputeP.usr.Kp)
    Real, // svar_Ki (ComputeP.usr.Ki)
    Real, // svar_Kd (ComputeP.usr.Kd)
    Real, // svar_SampleTime (ComputeP.usr.SampleTime)
  ) ;
  type Output = (
    Real, // svar_Output (ComputeP.usr.Output)
  ) ;
/*  fn arity() -> usize { 7 }
...
/// | Lustre identifier | Struct | Inputs | Outputs | Position |
/// |:---:|:---:|:---:|:---:|:---:|
/// | `limit` | [Limit](struct.Limit.html) | `abs_2` | `abs_3` | [pid2.lus line 37](../src/lus/pid2.lus.html#37) |
/// | `limit` | [Limit](struct.Limit.html) | `abs_0` | `abs_1` | [pid2.lus line 35](../src/lus/pid2.lus.html#35) |
///
/// # Assertions
///
/// /// No assertions for this system.
...
*/   fn init(input: Self::Input) -> Self {
    ...
    let svar_abs_2 = ((svar_Kp * svar_error) - (((svar_Kd * svar_dInput) * 1000f64) / svar_SampleTime)) ;
    let svar_abs_0 = 0f64 ;
