//! Implementation for lustre node `dkmfuzzy` (see [Dkmfuzzy](struct.Dkmfuzzy.html)).
//!
...
/// Stores the state for **top node** `dkmfuzzy`.
///
/// # Inputs
///
...
#[repr(C)]
  pub struct Dkmfuzzy {
  /// Input: `dkmfuzzy.usr.i`
  pub svar_i: Real,
  /// Input: `dkmfuzzy.usr.x`
  pub svar_x: Real,

  /// Output: `dkmfuzzy.usr.y`
  pub svar_y: Real,

  /// Local, local: `dkmfuzzy.impl.usr.dcenter7`
  pub svar_dcenter7: Real,
  /// Local, local: `dkmfuzzy.impl.usr.dcenter6`
  pub svar_dcenter6: Real,
  /// Local, local: `dkmfuzzy.impl.usr.dcenter5`
  pub svar_dcenter5: Real,
  /// Local, local: `dkmfuzzy.impl.usr.dcenter4`
  pub svar_dcenter4: Real,
  /// Local, local: `dkmfuzzy.impl.usr.dcenter3`
  pub svar_dcenter3: Real,
  /// Local, local: `dkmfuzzy.impl.usr.dcenter2`
  pub svar_dcenter2: Real,
  /// Local, local: `dkmfuzzy.impl.usr.dcenter1`
  pub svar_dcenter1: Real,

}

impl Sys for Dkmfuzzy {
  type Input = (
    Real, // svar_i (dkmfuzzy.usr.i)
    Real, // svar_x (dkmfuzzy.usr.x)
  ) ;
  type Output = (
    Real, // svar_y (dkmfuzzy.usr.y)
  ) ;
/*  fn arity() -> usize { 2 }
